...
//
// WHY HYDRADB FOR DATA STORAGE:
// ==============================
// This seed script populates HydraDB with a GRAPH of packages and dependencies.
// HydraDB stores:
//   - NODES: Packages (e.g., "react@18.0.0") with metadata (maintainers, downloads)
//   - EDGES: Dependencies (e.g., "react-dom depends on react") with relationship types
//   - NOVEL EDGES: Shared maintainers, CI/CD persistence paths, cross-ecosystem links
//
// Why not just use JSON files or PostgreSQL?
//   - JSON: No graph traversal capability. Can't answer "show me all transitive deps"
//   - PostgreSQL: Recursive CTEs are slow (5-10s vs 200ms). No native graph context.
//   - Vector DB: Can't represent graph structure. Only similarity/distance queries.
//
// HydraDB enables:
//   1. Real-time BFS/DFS traversal (queryForcefulRelations)
//   2. Path discovery (graphContext returns exact dependency chains)
//   3. Flexible schema (add new edge types like "installs_persistence" easily)
//   4. Hybrid search (semantic + keyword matching for package discovery)
//
// Usage:  npm run seed
